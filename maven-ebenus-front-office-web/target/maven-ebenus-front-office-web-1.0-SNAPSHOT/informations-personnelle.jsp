        ...
        <div class="header-outer" id="header-outer">
            ...
            <header id="header" class="header">
                <div class="header">
                    ...
                    <ul class="main-menu">
                        <li><a href="indexo.html">Accueil</a></li>
                        <li><a href="products.html">Produits</a></li>
                        <li><a href="qui-sommes-nous.html">Qui sommes-nous</a></li>
                        <li><a href="contact.html">Contactez-nous</a></li>
                        <li class="last">
                            <a href="compte-client.jsp" class="account-link">Mon Compte</a>
                            <ul class="sub-menu">
                                <li><a href="compte-client.jsp">Mon Compte</a></li>
                                <li class="guest">
                                    <a href="login.html">Login</a>
                                </li>
                                <li class="logged">
                                    <a href="informations-personnelle.jsp"><strong><%=session.getAttribute("civilite") %> <%=session.getAttribute("prenom") %> <%=session.getAttribute("nom") %></strong></a>
                                </li>
                ...
                <div class="customer-acount">
                    ...
                    <div class="account-container row">
                        <div class="facet-navigation col-md-3">
                            <ul>
                                <li><a href="informations-personnelle.jsp">Information personnelles</a></li>
                        ...
                        <div class=" common-form-controls col-md-9">
                            <div class=" common-form-controls">
                                <p>Bienvenue <%=session.getAttribute("civilite") %>  <strong><%=session.getAttribute("prenom") %> <%=session.getAttribute("nom") %></strong>,<br />
                                    Voici le récapitulatif de votre compte. Vous pouvez changer vos informations
                                    personnelles et gérer les options de votre compte.</p>
                            ...
                            <form id="customer-info-form" method="post" action="#" class="row validate no-gutters">
                                <fieldset class="col-md-6">
                                    ...
                                    <input value=<%=session.getAttribute("email") %> name="email" id="email" type="email">
