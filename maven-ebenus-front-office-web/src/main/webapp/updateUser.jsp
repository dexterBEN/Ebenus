<%@ page language="java" 
    ...
    import="com.cours.ebenus.maven.ebenus.front.office.web.UpdateUserServlet"
%>

<%@page import="com.cours.ebenus.maven.ebenus.front.office.web.LoginServlet" %>
	...
	<section>
		<div class="content">
			<div class="User">
				...
				<form id="customer-info-form" class="no-gutters" method="post" action="update">
					<div class="account-container row">

						<fieldset class=" common-form-controls col-md-5">
							<div>
								<label for="firstname">Prénom</label>
								<input value=<%=session.getAttribute("prenom") %> name="firstname" id="firstname" type="text">
								<label for="lastname">Nom</label>
								<input value=<%=session.getAttribute("nom")%> name="lastname" id="lastname" type="text">
								<label for="email">Identifiant</label>
								<input name="email" value=<%=session.getAttribute("email") %> id="email" type="email">

								<label for="dteCreation">Date création</label>
								<input value="15/10/2017" data-toggle="datepicker" name="dteCreation" id="dteCreation"
									type="text">

								<label for="dteModif">Date modification</label>
								<input value="18/11/2017" data-toggle="datepicker" name="dteModif" id="dteModif"
									type="text">
						...
						<fieldset class="col-md-5">
							...
							<input value="Administrateur" name="role" id="role" type="text">
							<label for="desc">Description</label>
							<textarea name="desc" rows="5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea, error.</textarea>
							<label for="password">Mot de passe</label>
							<input value="123456" name="password" id="password" type="password">
							<label for="password">Confimer mot de psse</label>
							<input value="123456" name="password" id="password-C" type="password">
